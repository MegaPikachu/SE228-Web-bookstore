								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										...
										<tr>
											...
											<td><%=book.getDate()%></td>
											<td>
												<button class="btn btn-default edit" type="button" data-toggle="modal" data-target="#myModal"
													data-id="<%=book.getId()%>"
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div id="bookdetailfound"></div>
				<table><tr><td>
				<span>Amount:</span></td><td><input class="form-control" 
				name="amount" type="number" step="1" style="width:60px"></td></tr> </table>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" 
						data-dismiss="modal">Close
				</button>
				<button type="button" class="btn btn-primary" id = "shoppingcart">
					Buy
				</button>
			</div>
		</div><!-- /.modal-content -->
