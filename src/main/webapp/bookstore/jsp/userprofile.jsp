...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				...
				<img alt="显示图片" src= "getUserPic?id=<%=theid %>" height="150px" width="150px"></img>
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="row">
						<div class="col-lg-12">
							<form role="form">
								...
								<div class="form-group">
									<label>Change Picture</label> <input  type="file"
									name="picture"  >
								</div>
							</form>
						</div>
	...
	<script src="<%=path%>/bookstore/js/userprofile.js"></script>
