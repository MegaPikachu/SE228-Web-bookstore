...
<body>
	 <%
	 	...
	 	if (session_username == null || !session_role.equals("Administrator")){
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<p>Search orders:</p>
							<label>Userid</label> <input name="userid" width=15>
							<label>Start date</label> <input name="startdate" type="date" width=15>
							<label>End date</label> <input name="enddate"  type="date" width=15>
							<div class="form-group">
									<label>Bookid</label>
									<select class="form-control" id="thebookid" style="width:100px">
										<%
											for (int i = 0; i < bookList.size(); i++) {
												Book the_book = bookList.get(i);
										%>
										<option value="<%=the_book.getId()%>"><%=the_book.getId()%></option>
										<%
											}
										%>
									</select>
								</div>
							<button type="button" class="btn btn-primary" id="getstastic">Search</button>
							<div id = thegotstatistic></div>
						</div>
						<!-- /.panel-heading -->
